        ...
        <div class="tab-content">
            <div class="col-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        <form class="" action="{{ route('admin.blog.update', [$blog->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="file" class="form-control-file dropify" name="thumbnail" required data-default-file="{{ asset($blog->thumbnail) }}">
                                </div>
                            </div>
                            <div class="position-relative form-group">
